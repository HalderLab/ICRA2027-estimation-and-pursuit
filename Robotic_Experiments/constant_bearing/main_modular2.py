...
class TwoAgentModularNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("alpha2_bias", 0.07)
        ...
        self.declare_parameter("leader_input_mode", "constant")
        ...
        self.declare_parameter("controller_use_estimated_v1", False)

        # ==============================================================
        # Shared EKF/PF measurement settings
        # ==============================================================
        self.declare_parameter("alpha1_initial_guess", 0.0)
        self.declare_parameter("v1_initial_guess", 0.10)
